...
said = " ".join(sys.argv[1:]) or "أبي أعرف شروط التمويل وكم القسط الشهري"
...
if not agent_id:
    ...
    audio = voho("/v1/speech", {"text": "أهلاً بك في النخبة المالية، معك ليلى. كيف أقدر أساعدك؟", "voice": "layla", "model": "sada-1", "format": "mp3"}, raw=True)
...
out = voho("/v1/agents/%s/reply" % agent_id, {
    "text": said,
    "variables": {"company": os.environ.get("VOHO_COMPANY", "النخبة المالية")},
})
